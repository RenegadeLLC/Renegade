<?php
/**
 * Template Name: Articles Archive Page Template
 *
...
$archive_year = get_field('archive_year');
...
//$archive_year = get_the_date( _x( 'Y', 'yearly archives date format', 'rmg' ) ) ;
...
$articlesHTML .= '<div class="outer-wrapper" style="background:#E6E7E8;"><div class="wrapper"><div class="year" id="' . $archive_year . '"></div>';
...
//	$articlesHTML .= '<div style="background-color:#333; overflow:hidden;" class="articles post-list" year="' . $archive_year . '">';
$articlesHTML .= '<div class="sort-bar"  year="' . $archive_year . '"><div class="sort-head">SORT BY: </div><div class="sort-option sort-on" title="date" type="articles">DATE</div>';
