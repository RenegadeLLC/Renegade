...
<?php 
		...
		$people_html .= '<div class="people-bio-intro">'. $rp_bio_intro . '</div>';
		...
		$people_html .= '<div class="people-social-ct"><a href="'. $rp_social_channel_url . '" target="_blank"><div class="people-social ' . $rp_social_icon . '"><div class="people-social-name">Follow<br>'. $rp_first_name .'</a></div></div></div>';
		}
