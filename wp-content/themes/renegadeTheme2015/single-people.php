...
$people_html .= '<div class="headline-ct"><h1>' . $rp_first_name . ' ' . $rp_last_name . '<span class="light-serif gray"> - ' . $rp_job_title  . '</span></h1><a href="#submenu" id="bt-submenu"><div class="bt-submenu"></div></a>';
...
?>
<nav id="submenu">
				<?php wp_nav_menu( array( 'menu' => 'people','theme_location' => 'people', 'menu_class' => 'sub-nav-menu','container_class' => 'sub-nav-menu-ct' ) ); ?>
</nav>
...
$people_html .= '<div class="person-content-ct">';	
		...
		//MAIN BIO IMAGE
		$people_html .= '<div class="people-bio-image-ct grid-item grid-item-w-50" style="max-width:600px; max-height:600px;"><div class="people-bio-image">' .  wp_get_attachment_image($rp_bio_image, $rp_size ) . '</div></div>';
		
		//CONTACT BOX
		$people_html .= '<div class="contact-box-outer grid-item grid-item-w-25 square"><div class="vert-center-outer"><div class="vert-center-inner"><div class="circle"><div class="vert-center-outer"><div class="vert-center-inner email"><a href="mailto:' .  $rp_email_address . '">Contact<span class="mobile-hide">'. $rp_first_name . '</span></a></div></div></div></div></div></div>';
		...
		$people_html .= '<div class="circle"><div class="vert-center-outer"><div class="vert-center-inner">';
				$people_html .= '<div class="people-social-ct"><div class="people-social ' . $rp_social_icon . '"><a href="'. $rp_social_channel_url . '" target="_blank"><div class="people-social-name">Follow<span class="mobile-hide"> '. $rp_first_name .'</span></a></div></div></div>';
		endif;
		...
		$people_html .= '<div class="bio-outer grid-item grid-item-w-75b"><div class="people-bio-text-ct"><div class="random-inline-image mobile-show"><img src="'. $rp_random_image .'"></div><div class="people-bio-text">' . $rp_biography . '</div></div></div>';
