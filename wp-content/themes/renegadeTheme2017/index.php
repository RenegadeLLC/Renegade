...
$left_column_rss_feed_url = get_field('left_column_rss_feed_url', get_option('page_for_posts'));
...
$right_column_rss_feed_url = get_field('right_column_rss_feed_url', get_option('page_for_posts'));
...
$pageHTML .= do_shortcode( '[recent_rss feed="' . $left_column_rss_feed_url . '" excerpt="Yes" numberposts="8" text_color="#000"]' );
...
//$pageHTML .= do_shortcode( '[recent_rss feed="http://feeds.feedburner.com/theDrewBlog" excerpt="Yes" numberposts="4" text_color="#000"]' );
$pageHTML .= do_shortcode( '[recent_rss feed="' . $right_column_rss_feed_url . '" excerpt="Yes" numberposts="8" text_color="#000"]' );
