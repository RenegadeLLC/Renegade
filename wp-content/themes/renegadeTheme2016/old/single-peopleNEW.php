...
$people_html .= '<div class="headline-ct"><h1>' . $rp_first_name . ' ' . $rp_last_name . '<span class="light-serif gray"> - ' . $rp_job_title  . '</span></h1><a href="#submenu"><div class="bt-submenu"></div></a><div class="sub-nav-menu-ct" id="submenu">';
wp_nav_menu( array( 'menu' => 'people','theme_location' => 'people', 'menu_class' => 'sub-nav-menu' ) ); 
$people_html .= 'where is it??';
