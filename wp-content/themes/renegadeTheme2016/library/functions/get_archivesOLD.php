	...
	if ($year_current != $year_prev){
		...
		<?php if($type == 'yearly'):?>
			<a href="<?php bloginfo('url') ?>/
				<?php echo $month->year; ?><?php if($post_type != 'post'):
		...
		<?php echo $month->year; ?>/<?php echo date("m", mktime(0, 0, 0, $month->month, 1, $month->year)) ?>/<?php if($post_type != 'post'):
		echo('?post_type=' . $post_type);
		endif;
		?>"><span class="archive-month"><?php echo date_i18n("F", mktime(0, 0, 0, $month->month, 1, $month->year)) ?>		</span></a></li>
