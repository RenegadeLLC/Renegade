...
if( have_rows('content_sections') ):
    ...
    if($content_section_type == 'Custom Section'):
        ...
        elseif($content_section_type == 'Team Bio'):
            ...
            $team_member = get_sub_field('team_bio');
...
?>
	...
	$(document).ready(function() {
		...
		$('.section-headline-ct').each(function(){
		var bkImg = $(this).children('img');
		$(bkImg).css('border', '1px solid red');
		var bkImgH = $(bkImg).height();
		
		if(bkImgH != 0){
			$(this).height(bkImgH);
			//$(this).children('.section_headine_text').css('padding-top', '86px');
			$(this).children('.section_headine_text').css('border', '1px solid red');
			//$(this).children('.section_headine_text').css('border', '1px solid red');
		}
		});
