...
class WD_ASP_Init {
    ...
    public function scripts() {
        ...
        if ( $load_lazy ) {
            if ( ASP_DEBUG == 1 || defined('WP_ASP_TEST_ENV') ) {
                wp_register_script('wd-asp-lazy', ASP_URL_NP . 'js/nomin/jquery.lazy.js', array('jquery'), $media_query, $load_in_footer);
                wp_enqueue_script('wd-asp-lazy');
            } else if ( strpos($js_source, 'scoped') !== false ) {
                wp_register_script('wd-asp-lazy', ASP_URL_NP . 'js/min-scoped/jquery.lazy.min.js', array('wd-asp-ajaxsearchpro'), $media_query, $load_in_footer);
                wp_enqueue_script('wd-asp-lazy');
            } else {
                wp_register_script('wd-asp-lazy', ASP_URL_NP . 'js/min/jquery.lazy.min.js', array('jquery'), $media_query, $load_in_footer);
                wp_enqueue_script('wd-asp-lazy');
            }
        }
