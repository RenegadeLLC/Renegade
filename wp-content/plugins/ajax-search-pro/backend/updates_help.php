...
<div id="wpdreams" class='asp_updates_help<?php echo isset($_COOKIE['asp-accessibility']) ? ' wd-accessible' : ''; ?>'>
	<div class="wpdreams-box" style="float: left;">
		<div class="wpd-half">
			...
			<div class="item">
				<ul>
					<li><a target="_blank" href="https://documentation.ajaxsearchpro.com/" title="HTML documentation">HTML version</a></li>
		...
		<div class="wpd-half-last">
            ...
            <div class="item">
                <a target="_blank" href="https://documentation.ajaxsearchpro.com/update_notes.html">How to manual update?</a>
            </div>
            <?php endif; ?>
			<h3>Changelog</h3>
			<div class="item">
