      ...
      <div class='wpdreamsTermMeta' id='wpdreamsTermMeta-" . self::$_instancenumber . "'>
        <fieldset>
          <legend>" . $this->label . "</legend>";
            ...
            <p>Available term meta keys</p><ul id="sortable' . self::$_instancenumber . '" class="connectedSortable">';
            ...
            echo "</ul></div>";
            echo '<div class="sortablecontainer"><p>Drag here the meta keys you want to use!</p><ul id="sortable_conn' . self::$_instancenumber . '" class="connectedSortable">';
