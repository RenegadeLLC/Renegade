...
if (!class_exists("wpdreamsFont")) {
     ...
     * Class wpdreamsFont
     *
     * A font selector UI element with various options.
     *
    ...
    class wpdreamsFont extends wpdreamsType {
      ...
      ";
            ...
            echo "<select class='wpdreamsfontselect' id='wpdreamsfont_" . self::$_instancenumber . "' name='" . self::$_instancenumber . "_select'>";
            $options = '
      ...
      ';
            ...
            if ($this->weight == "")
                $this->weight = "normal";
            echo "</select>";
            echo "<input type='hidden' value='wpdreamsFont' name='wpdfont-" . $this->name . "'>";
        ...
        jQuery(document).ready(function($) {
            setTimeout(function() {
                $('#wpdreamsfont_" . self::$_instancenumber . "').change();
            }, 2000);
        }(jQuery));
        </script>
      </fieldset>
