    ...
    class wd_UserMeta extends wpdreamsType {
        ...
        function getType()
        {
            ...
            ?>
                ...
                Use the search bar above to look for user meta fields :)
                </ul></div>
                <div class="sortablecontainer"><p>Drag here the user meta fields you want to use!</p><ul id="sortable_conn<?php echo $inst; ?>" class="connectedSortable">
                <?php
