...
function custom_orderby( $query ) {
	if( ! is_admin() )
		...
		if( 'ra_publication' == $orderby ) {
			$query->set('meta_key','ra_publication');
			$query->set('orderby','meta_value');
		}
		elseif ( 'ra_date' == $orderby ) {
			$query->set('meta_key','ra_date');
			$query->set('orderby','meta_value_num');
		}
		elseif ( 'ra_author' == $orderby ) {
			$query->set('meta_key','ra_author');
			$query->set('orderby','meta_value');
		}
}
