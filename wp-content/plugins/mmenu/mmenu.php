 ...
 * Plugin URI: http://mmenu.frebsite.nl
		...
		array(
			...
			'content'   => '
				...
				<p>The "locate on website" popup makes an educated guess about what HTML element might be the menu, using common HTML patterns used by WordPress.<br />
					If that also does not find the right menu, you can still specify it manually by typing the selector (for example "#my-menu") in the "selector" combobox.</p>'
		),
		array(
			...
			'content'   => '
				...
				<p>The "locate on website" popup makes an educated guess about what HTML element might be the menu button, using common HTML patterns used by WordPress.<br />
					If that also does not find the right button, you can still specify it manually by typing the selector (for example "#my-button") in the "selector" combobox.</p>'
		),
		array(
			'id'        => 'mmenu-help-icons',
	...
	*/
	...
	protected function saveFrontend( $fileAffix = '' )
	{
		...
		$dir = dirname( __FILE__ ) . '/';
  		...
  		$js = @file_get_contents( $src . 'jquery.mmenu.min.all.js' );
  		$js .= '
...
';
	...
	public function admin_css_js( $screen_id )
	{
		...
		if ( $screen_id == $this->screen_id )
		{
			...
			wp_enqueue_script(	'mmenu', plugin_dir_url( __FILE__ ) . 'mmenu/jquery.mmenu.min.all.js' );
		}
